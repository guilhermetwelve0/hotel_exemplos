    ...
    <div class="container">
        <div class="box">
            <div class="text">
                ...
                <h3>Desde o início, há mais de uma década, nossa jornada foi marcada por um compromisso apaixonado com a hospitalidade. Ao longo dos anos, construímos experiências únicas e inesquecíveis para todos os nossos hóspedes.</h3>
            </div>
        </div>
        <div class="image">
            <img src="{{asset('img/home1.jpg')}}" class="slide">
        ...
        <section class="home" id="home">
            <div class="head_container">
                <div class="box">
                    <div class="text">
                        <h2>Nossa Missão</h2>
                        <h3>Nossa missão é simples: superar as expectativas de nossos hóspedes. Queremos que cada
                            estadia
